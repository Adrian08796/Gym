...
function ExerciseModal({ exercise, onClose, onEdit, onDelete, onAddToPlan }) {
  ...
  return (
    ...
    >
      <div 
        className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-4 p-6 lg:p-8"
          ...
          <div className="lg:w-1/2 pl-0 lg:pl-8">
            ...
            <div className="flex flex-wrap justify-between">
              <button 
                ...
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded text-lg mb-2 lg:mb-0"
              >
                Edit
              </button>
              <button 
                onClick={() => onDelete(exercise._id)}
                className="bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-6 rounded text-lg mb-2 lg:mb-0"
              >
                Delete
              </button>
              <button 
                onClick={() => onAddToPlan(exercise)}
                className="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-6 rounded text-lg mb-2 lg:mb-0"
              >
                Add to Plan
              </button>
            </div>
